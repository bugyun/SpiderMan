...
class LogHookConfig {
    ...
    static {
        ...
        sInterfaceMethods.put('onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V', new LogMethodCell(
                ...
                [Opcodes.ALOAD, Opcodes.ALOAD, Opcodes.ILOAD]))
        sInterfaceMethods.
                put('onGroupClick(Landroid/widget/ExpandableListView;Landroid/view/View;IJ)Z', new LogMethodCell(
                        'onGroupClick',
                        ...
                        [Opcodes.ALOAD, Opcodes.ALOAD, Opcodes.ILOAD]))
        sInterfaceMethods.
                put('onChildClick(Landroid/widget/ExpandableListView;Landroid/view/View;IIJ)Z', new LogMethodCell(
                        'onChildClick',
